...
// GET route voor de index, maar dan gesorteerd op leeftijd (geboortedatum)
...
// GET route voor de index, maar dan gesorteerd op afgeronde hoeken
app.get('/border-radius', async function (request, response) {

  // Haal alle personen uit de WHOIS API op, van dit jaar, gesorteerd op naam
  const params = {
    // Sorteer op border-radius, van hoog naar laag
...
// Oefening 2 User Generated Content
let messages = []
